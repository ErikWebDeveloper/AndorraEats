      ...
      <div className="container">
        ...
        <section className="py-5 text-center">
          ...
          <p className="text-muted">
            ¡Y lo mejor de todo es que puedes añadir tu restaurante de manera
            gratuita! 🏅
          </p>
        </section>
        ...
        <section className="py-5">
          <h2 className="display-5 text-center mb-3">¿Quien somos?</h2>
              ...
              <div className="col-12 col-md-5 mb-4">
                ...
                >
                  <div className="card-body text-center">
                    <h2 className="card-title mb-4">Prueba nuestra App 🥳</h2>
              ...
              <div className="col-12 col-md-5 mb-4">
                ...
                >
                  <div className="card-body text-center">
                    ...
                    <p className="card-text mb-4">
                      Ofrecemos un servicio gratuito y amigable para mejorar la
                      visibilidad de tu restaurante entre los turistas.
                    </p>
                    <a
        ...
        {/* Text */}
        <section className="py-5">
          <h2 className="display-5 text-center mb-3">Ventajas</h2>
          <p className="lead text-center">
        ...
        <section className="py-5">
          ...
          <p className="lead text-center">
            ...
            experiencia en nuestro país. Con <strong>Andorra Eats App</strong>,
            todo el mundo gana. 🏆📲
          </p>
        </section>
      </div>
